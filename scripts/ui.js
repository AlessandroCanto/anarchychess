...
CHESSAPP.ui = (function(){
	...
	**/
	...
	rightCol = null,
	moveList = null,//Visual Display of Moves
	...
	var createSelection = function(){
		...
		CHESSAPP.utils.bind(selection, "click", uiComponents.promotionClicked);
	...
	var createColor = function(){
		...
		CHESSAPP.utils.bind(color, "click", uiComponents.preferredClicked);
	...
	createInitial = function(){
		...
		CHESSAPP.utils.bind(initial, "click", uiComponents.modeClicked);
 ...
 */
	...
	uiComponents.init = function(stg){
	...
	uiComponents.addChatMessage = function(stg){
	...
	uiComponents.addMove = function(txt){
   ...
   */
	uiComponents.statusUpdate= function(stg){
		stg.showTime = true;
		statusWindow.add(stg);
	};
	uiComponents.drawPieces= function(pieces, cells){
	...
	uiComponents.addPiece = function(piece, cell){
		cell.reference.appendChild(piece.reference);
	};
	uiComponents.updatePiece = function(piece){
	...
	uiComponents.addOptionStyles = function(cell, userSettings){
		var stg = {
			attackable: true,
			movable: true
		};        
	...
	uiComponents.modeClicked= function(e){
		e.preventDefault();
		e.stopPropagation();
		e = e || window.event;
	...
	uiComponents.preferredClicked = function(e){
		e.preventDefault();
		e.stopPropagation();
		e = e || window.event;
		src = e.target || e.srcElement;
	...
	uiComponents.promotionClicked = function(e){
		e.preventDefault();
		e.stopPropagation();
		e = e || window.event;
		src = e.target || e.srcElement;
	...
	uiComponents.boardClicked = function(e){
